...
public final class FragmentFirstBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView mouseDataTextView;

  @NonNull
  public final TextView textviewFirst;

  private FragmentFirstBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView mouseDataTextView, @NonNull TextView textviewFirst) {
    this.rootView = rootView;
    this.mouseDataTextView = mouseDataTextView;
  ...
  public static FragmentFirstBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.mouseDataTextView;
      TextView mouseDataTextView = ViewBindings.findChildViewById(rootView, id);
      if (mouseDataTextView == null) {
        break missingId;
      }
      ...
      return new FragmentFirstBinding((ConstraintLayout) rootView, mouseDataTextView,
          textviewFirst);
    }
